...
import com.google.appinventor.shared.rpc.project.BuildRequest;
...
public class BuildCommand extends ChainableCommand {
  ...
  public void execute(final ProjectNode node) {
    ...
    ode.getProjectService().build(new BuildRequest(node.getProjectId(), nonce, target, secondBuildserver), callback);
  }
}
