...
import com.google.appinventor.shared.rpc.project.AddFileRequest;
  ...
  private class NewFormDialog extends DialogBox {
    ...
    protected void addFormAction(final YoungAndroidProjectNode projectRootNode, 
      ...
      OdeAsyncCallback<Long> callback = new OdeAsyncCallback<Long>(
        ...
        @Override
        public void onSuccess(Method method, Long modDate) {
          final Ode ode = Ode.getInstance();
      ...
      // (.blk) files.
      ode.getProjectService().addFile(new AddFileRequest(projectRootNode.getProjectId(), formFileId), callback);
    }
