...
import com.google.appinventor.shared.rpc.project.ImportMediaRequest;
  ...
  public UrlImportWizard(final FolderNode assetsFolder, OnImportListener listener) {
    ...
    initFinishCommand(new Command() {
      ...
      public void execute() {
        ...
        ode.getProjectService().importMedia(new ImportMediaRequest(ode.getSessionId(), projectId, url, true), new OdeAsyncCallback<TextFile>() {
          @Override
          public void onSuccess(Method method, TextFile file) {
