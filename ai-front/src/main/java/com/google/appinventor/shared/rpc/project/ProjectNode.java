...
@JsonSubTypes({
        @JsonSubTypes.Type(FolderNode.class),
        @JsonSubTypes.Type(SourceFolderNode.class),
        @JsonSubTypes.Type(YoungAndroidSourceFolderNode.class),
        @JsonSubTypes.Type(PackageNode.class),
        @JsonSubTypes.Type(YoungAndroidPackageNode.class),
        @JsonSubTypes.Type(YoungAndroidAssetsFolder.class),
        @JsonSubTypes.Type(YoungAndroidComponentsFolder.class),
        @JsonSubTypes.Type(YoungAndroidProjectNode.class),
        @JsonSubTypes.Type(FileNode.class),
        @JsonSubTypes.Type(YoungAndroidBlocksNode.class),
        @JsonSubTypes.Type(YoungAndroidYailNode.class),
        @JsonSubTypes.Type(YoungAndroidFormNode.class),
        @JsonSubTypes.Type(YoungAndroidAssetNode.class),
        @JsonSubTypes.Type(YoungAndroidComponentNode.class),
})
public abstract class ProjectNode implements Serializable, IsSerializable {
     ...
     * @return iterable
     */
    public Collection<ProjectNode> getChildren() {
