...
import com.google.appinventor.shared.rpc.component.ImportComponentToProjectRequest;
...
public class ComponentImportWizard extends Wizard {
    ...
    private static class ImportComponentCallback extends OdeAsyncCallback<ComponentImportResponse> {
        @Override
        public void onSuccess(Method method, ComponentImportResponse response) {
        ...
        initFinishCommand(new Command() {
            ...
            public void execute() {
                ...
                if (tabPanel.getTabBar().getSelectedTab() == URL_TAB) {
                    ...
                    ode.getComponentService().importComponentToProject(new ImportComponentToProjectRequest(url, projectId,
                    ...
                    Uploader.getInstance().upload(fileUpload, url,
                            new AsyncCallback<UploadResponse>() {
                                ...
                                public void onSuccess(UploadResponse uploadResponse) {
                                    ...
                                    ode.getComponentService().importComponentToProject(new ImportComponentToProjectRequest(toImport, projectId,
                                            assetsFolderNode.getFileId()), new ImportComponentCallback());
                                }
