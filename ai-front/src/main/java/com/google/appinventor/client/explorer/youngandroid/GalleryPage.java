            ...
            Uploader.getInstance().upload(upload, uploadUrl,
                    new AsyncCallback<UploadResponse>() {
                        ...
                        public void onFailure(Throwable caught) {
                            String errorMessage = MESSAGES.fileUploadError();
    ...
    private void updateAppImage(String url, final Panel container) {
        ...
        if (gallery.getSystemEnvironment() != null &&
            ...
            final OdeAsyncCallback<String> callback = new OdeAsyncCallback<String>(
                ...
                @Override
                public void onSuccess(Method method, String newUrl) {
    ...
    */
    ...
    private FlowPanel initRemixFromButton() {
        ...
        final OdeAsyncCallback<Long> remixedFromCallback = new OdeAsyncCallback<Long>(
                ...
                MESSAGES.galleryError()) {
            @Override
            public void onSuccess(Method method, final Long attributionId) {
                if (attributionId != UserProject.FROMSCRATCH) {
                    ...
                    final OdeAsyncCallback<GalleryApp> callback = new OdeAsyncCallback<GalleryApp>(
                            ...
                            MESSAGES.galleryError()) {
                        @Override
                        public void onSuccess(Method method, GalleryApp AppRemixedFrom) {
        ...
        final OdeAsyncCallback<List<GalleryApp>> callback = new OdeAsyncCallback<List<GalleryApp>>(
                ...
                MESSAGES.galleryError()) {
            @Override
            public void onSuccess(Method method, final List<GalleryApp> apps) {
                if (apps.size() != 0) {
    ...
    private void initReportSection() {
        ...
        final OdeAsyncCallback<Boolean> isReportdByUserCallback = new OdeAsyncCallback<Boolean>(
                ...
                MESSAGES.galleryError()) {
            @Override
            public void onSuccess(Method method, Boolean isAlreadyReported) {
                    ...
                    submitReport.addClickHandler(new ClickHandler() {
                        public void onClick(ClickEvent event) {
                            ...
                            if (!reportText.getText().trim().isEmpty()) {
                                Ode.getInstance().getGalleryService().addAppReport(new AddAppReportRequest(app, reportText.getText()),
                                        reportClickCallback);
                                descriptionError.setVisible(false);
                            } else {
        ...
        likePrompt.addClickHandler(new ClickHandler() {
            public void onClick(ClickEvent event) {
                final OdeAsyncCallback<Integer> changeLikeCallback = new OdeAsyncCallback<Integer>(
                        ...
                        MESSAGES.galleryError()) {
                    @Override
                    public void onSuccess(Method method, Integer num) {
                        ...
                        Ode.getInstance().getGalleryService().checkIfSendAppStats(app.getGalleryAppId(), new CheckIfSendAppStatsRequest(app.getDeveloperId(),
        ...
        salvagePrompt.addClickHandler(new ClickHandler() {
            public void onClick(ClickEvent event) {
                final OdeAsyncCallback<Void> callback = new OdeAsyncCallback<Void>(
                        ...
                        MESSAGES.galleryError()) {
                    @Override
                    public void onSuccess(Method method, Void bool) {
        ...
        actionButton.addClickHandler(new ClickHandler() {
            public void onClick(ClickEvent event) {
                ...
                final OdeAsyncCallback<GalleryApp> callback = new OdeAsyncCallback<GalleryApp>(
                    ...
                    public void onSuccess(Method method, final GalleryApp gApp) {
                ...
                Ode.getInstance().getGalleryService().publishApp(new PublishAppRequest(app.getProjectId(),
    ...
    private void initUpdateButton() {
        ...
        actionButton.addClickHandler(new ClickHandler() {
            public void onClick(ClickEvent event) {
                ...
                Ode.getInstance().getGalleryService().updateApp(new UpdateAppRequest(app, imageUploaded), updateSourceCallback);
            }
        });
        actionButton.addStyleName("app-action-button");
        appAction.add(actionButton);
