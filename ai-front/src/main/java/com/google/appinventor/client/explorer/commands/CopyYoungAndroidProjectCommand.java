...
import com.google.appinventor.shared.rpc.project.CopyProjectRequest;
  ...
  private class CopyProjectDialog extends DialogBox {
    ...
    protected void copyProjectAction(ProjectRootNode oldProjectNode, String newName) {
      ...
      OdeAsyncCallback<UserProject> callback = new OdeAsyncCallback<UserProject>(
        ...
        @Override
        public void onSuccess(Method method, UserProject newProjectInfo) {
          // Update project list
      ...
      ode.getProjectService().copyProject(new CopyProjectRequest(oldProjectNode.getProjectId(), newName), callback);
    }
